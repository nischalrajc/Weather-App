...
function Highlights({ stats }) {
    return (
        <div className='bg-slate-600 p-2 text-slate-200 flex flex-col items-center text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer'>
            <h2 className='text-sm mt-2 '>{stats.tittle}</h2>
            <div className='mt-2'>
